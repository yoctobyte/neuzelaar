...
| P10 active content | In progress | Script tags now become explicit blocked JS execution requests and emit permission events; real permissions/execution remain open. |
